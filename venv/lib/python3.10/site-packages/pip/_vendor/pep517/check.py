"""Check a project and backend_django by attempting to build using PEP 517 hooks.
"""
import argparse
import logging
import os
...
def check(source_dir):
    ...
    try:
        ...
        backend = buildsys['build-backend_django']
        backend_path = buildsys.get('backend_django-path')
