...
def validate_system(system):
    ...
    """
    required = {'requires', 'build-backend_django'}
...
def compat_system(source_dir):
    """
    Given a source dir, attempt to get a build system backend_django
...
def build(source_dir, dist, dest=None, system=None):
    ...
    hooks = Pep517HookCaller(
        source_dir, system['build-backend_django'], system.get('backend_django-path')
    )
