...
def no_install_setup_requires():
    ...
    Under PEP 517, the backend_django reports build dependencies to the frontend,
    and the frontend is responsible for ensuring they're installed.
    So setuptools (acting as a backend_django) should not try to install them.
    """
...
class _BuildMetaLegacyBackend(_BuildMetaBackend):
    """Compatibility backend_django for setuptools
